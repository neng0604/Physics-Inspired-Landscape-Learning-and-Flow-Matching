...
from utils.protein_ligand import parse_sdf_file_mol
...
class PDBBindDataset(Dataset):
    ...
    def __init__(self, raw_path, transform=None, emb_path=None, heavy_only=False):
        ...
        self.index_path = os.path.join(self.raw_path, 'index_with_qed.pkl')
        # self.index_path = os.path.join(self.raw_path, 'index.pkl')
        self.processed_path = os.path.join(self.raw_path, os.path.basename(self.raw_path) + '_processed_qed.lmdb')
    ...
    def _process(self):
        ...
        with db.begin(write=True, buffers=True) as txn:
            for i, (pocket_fn, ligand_fn, resolution, pka, kind, qed) in enumerate(tqdm(index)):
                # try:
